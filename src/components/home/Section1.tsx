  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start justify-center w-full mt-12 lg:mt-8 gap-4 md:gap-2">
        {/* LEFT — TEXT */}
        <p className="text-lg leading-relaxed font-normal text-gray-00 max-w-2xl text-center md:text-justify md:mr-8">
        ...
        <img
          ...
          alt="Rama Krishna"
          className="w-56 h-56 md:w-56 md:h-46 rounded-xl object-cover shadow-lg"
        />
      </div>
